  ...
  <div class="auth-page">
      <v-container class="fill-height align-center justify-center">
        <v-card class="auth-card" elevation="10">
                ...
                <v-label v-if="message" class="text-subtitle-1 font-weight-semibold pb-2 text-lightText">
                    {{ message }}
                </v-label>
                ...
                <h6 class="text-h6 mt-3 font-weight-medium">
                    <router-link to="/login"><v-btn variant="text" color="primary" class="pl-1"> Sign in Now </v-btn></router-link>
                </h6>
            </v-card>
      </v-container>
  </div>
